    ...
    <div className="flex min-h-screen items-center justify-center bg-gray-50 px-4 py-12 dark:bg-gray-900 sm:px-6 lg:px-8">
      <div className="w-full max-w-md space-y-8">
        ...
        <button
          onClick={() => googleLogin()}
          disabled={loading}
          className="w-full flex items-center justify-center gap-3 rounded-lg bg-white px-4 py-3 text-gray-700 shadow-sm border border-gray-300 hover:bg-gray-50 disabled:opacity-50 transition-colors"
        >
          {/* Google 아이콘 */}
